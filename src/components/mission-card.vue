<template>
  <article class="mission-card" :class="{ 'is-reversed': reverseMobile }">
    ...
    <img v-if="imageSrc" class="mission-image" :src="imageSrc" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 600px" :alt="title" width="600" height="480" loading="lazy" decoding="async" />
