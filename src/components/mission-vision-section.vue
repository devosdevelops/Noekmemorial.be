<template>
  <section class="page-section mission-vision" id="over-ons" aria-labelledby="mission-vision-heading" v-scroll-reveal>
    <div class="section-container mission-vision-inner">
...
import MissionCard from './mission-card.vue';
</script>
